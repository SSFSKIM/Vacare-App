...
const STORAGE_KEY = 'engineering_technology_knowledge_test_progress';

export default function EngineeringTechnologyKnowledgeTest() {
  ...
  const { setKnowledgeResults, storeLoading, storeError } = useKnowledgeTestStore('engineering-technology-knowledge');
  ...
  React.useEffect(() => {
    const savedAnswers = localStorage.getItem('engineering-technology-knowledge-answers');
    if (savedAnswers) {
  ...
  React.useEffect(() => {
    localStorage.setItem('engineering-technology-knowledge-answers', JSON.stringify(answers));
  }, [answers]);
  ...
  React.useEffect(() => {
    const fetchQuestions = async () => {
      try {
        ...
        // Filter only engineering and technology questions
        const engineeringQuestions = data.filter((q: any) => [
          "Design",
        ...
        setQuestions(engineeringQuestions);
      } catch (err) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      // Clear local storage
      localStorage.removeItem('engineering-technology-knowledge-answers');
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-16">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-4xl font-bold mb-8 text-center">Engineering and Technology Knowledge Assessment</h1>
          <div className="mb-8">
          ...
          <p className="text-lg text-muted-foreground mb-8 text-center">
            Rate your interest in developing engineering and technology knowledge on a scale from 0 to 100.
            Focus on how enthusiastic you would be to learn more in these areas, not your current expertise.
          </p>

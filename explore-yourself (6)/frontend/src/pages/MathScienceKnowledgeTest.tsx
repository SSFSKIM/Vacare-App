...
const STORAGE_KEY = 'math_science_knowledge_test_progress';

export default function MathScienceKnowledgeTest() {
  ...
  const { setKnowledgeResults, storeLoading, storeError } = useKnowledgeTestStore('math-science-knowledge');
  ...
  React.useEffect(() => {
    const savedAnswers = localStorage.getItem('math-science-knowledge-answers');
    if (savedAnswers) {
  ...
  React.useEffect(() => {
    localStorage.setItem('math-science-knowledge-answers', JSON.stringify(answers));
  }, [answers]);
  ...
  React.useEffect(() => {
    const fetchQuestions = async () => {
      try {
        ...
        // Filter only mathematics and science questions
        const mathScienceQuestions = data.filter((q: any) => [
          "Chemistry",
          "Mathematics",
          "Biology",
          "Physics",
        ...
        setQuestions(mathScienceQuestions);
      } catch (err) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      // Clear local storage
      localStorage.removeItem('math-science-knowledge-answers');
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-16">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-4xl font-bold mb-8 text-center">Mathematics and Science Knowledge Assessment</h1>
          <div className="mb-8">
          ...
          <p className="text-lg text-muted-foreground mb-8 text-center">
            Rate your interest in developing mathematics and science knowledge on a scale from 10 to 100.
            Focus on how enthusiastic you would be to learn more in these areas, not your current level.
          </p>

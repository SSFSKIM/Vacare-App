...
export default function SocialSkillsTest() {
  ...
  const { setSkillResults, storeLoading, storeError } = useSkillTestStore('social');
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      // Store the results
      console.log('Setting skill results for social:', resultsWithSubset);
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-16">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-4xl font-bold mb-8 text-center">Social Skills Assessment</h1>
          <p className="text-lg text-muted-foreground mb-8 text-center">
            Rate your interest in developing social skills on a scale from 10 to 100.
            Focus on how eager you would be to improve these skills in the future, not your current level.
          </p>

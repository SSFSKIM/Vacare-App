...
const STORAGE_KEY = 'business_management_knowledge_test_progress';

export default function BusinessManagementKnowledgeTest() {
  ...
  const { setKnowledgeResults, storeLoading, storeError } = useKnowledgeTestStore('business-management-knowledge');
  ...
  React.useEffect(() => {
    const savedAnswers = localStorage.getItem('business-management-knowledge-answers');
    if (savedAnswers) {
  ...
  React.useEffect(() => {
    localStorage.setItem('business-management-knowledge-answers', JSON.stringify(answers));
  }, [answers]);
  ...
  React.useEffect(() => {
    const fetchQuestions = async () => {
      try {
        ...
        // Filter only business and management questions
        const businessQuestions = data.filter((q: any) => [
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      // Clear local storage
      localStorage.removeItem('business-management-knowledge-answers');
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-16">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-4xl font-bold mb-8 text-center">Business and Management Knowledge Assessment</h1>
          <div className="mb-8">
          ...
          <p className="text-lg text-muted-foreground mb-8 text-center">
            Rate your interest in developing business and management knowledge on a scale from 10 to 100.
            Focus on how passionate you would be to learn more in these areas, not your current expertise.
          </p>

...
const STORAGE_KEY = 'systems_skills_test_progress';

export default function SystemsSkillsTest() {
  ...
  const { setSkillResults, storeLoading, storeError } = useSkillTestStore('systems');
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      // Store the results
      console.log('Setting skill results for systems:', resultsWithSubset);
      await setSkillResults(resultsWithSubset);
      
      navigate("/skill-selection");
    } catch (err) {
      console.error('Error submitting systems skills test:', err);
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-16">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-4xl font-bold mb-8 text-center">Systems Skills Assessment</h1>
          <div className="mb-8">
          ...
          <p className="text-lg text-muted-foreground mb-8 text-center">
            Rate your interest in developing systems skills on a scale from 10 to 100.
            Focus on how eager you would be to improve these skills in the future, not your current ability.
          </p>
